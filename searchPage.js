...
var {
  StyleSheet, Text, TextInput, View, TouchableHighlight, ActivityIndicatorIOS, Image, Component
} = React;
  	...
  	return (
        ...
        <View style={styles.flowRight}>
          <TextInput value={this.state.searchString} 
                     ...
                     placerholder='Search via name or postcode'
                     onChange={this.onSearchTextChanged} />
          <TouchableHighlight onPress={this.onSearchPressed} style={styles.button} underlayColor='#99d9f4'>
